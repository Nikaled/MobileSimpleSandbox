...
public class Geekplay : MonoBehaviour
{
  ...
  //  public LeaderboardInGame leaderboardInGame2;
   ...
   // public LeaderboardInGame leaderboardInGame3;
    ...
    [Header("Android")]
    [SerializeField] private CASAds casAds;
        ...
        switch (Platform)
        {
            ...
            case Platform.Android:
                ...
                for (int i = 0; i < rewardsList.Length; i++)
                {
                    ...
                    {
                        casAction = null;
                        casAction += rewardsList[i].rewardEvent.Invoke;
                        Save();
                    }
                }
                casAds.ShowRewarded(casAction);
                break;
        }
    }
        
    IEnumerator BannerCAS()
    {
    ...
    public void ShowBannerAd() 
    {
        switch (Platform)
        {
            ...
            case Platform.OK:
                ...
                break;
            case Platform.Android:
                casAds.ShowBanner(bannerPosition);
                break;
        }
    }
    ...
    { 
        ...
        if (Platform == Platform.GameDistribution || Platform == Platform.CrazyGames || Platform == Platform.Editor || Platform == Platform.Android)
        {
            AfterPlatformChange();
        }
